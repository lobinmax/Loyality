...
-- ВЫПУСК КАРТЫ И ПЕРВОЕ ПОПОЛНЕНИЕ
-- =============================================
CREATE PROCEDURE [bonus-charge].[GetDocsSource_CardRelease]
	@DtStart DATE, 
	@DtEnd DATE, 
